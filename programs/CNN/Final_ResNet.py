''' aitao use kora jabe and aitao thik ace '''
...
def ResNet50(input_shape=(imgsz, imgsz, 3)):
...
base_model = ResNet50(input_shape=(imgsz, imgsz, 3))
...
H = model.fit(train_generator,validation_data=test_generator,epochs=100,verbose=1)
...
model.save("F:/Thesis_CE18030&60/resource/CNN/resnet50.h5")
print("saved")
